                        ...
                        <form action="check.php" method="post" enctype="multipart/form-data">
                            <div class="col-xs-12 col-sm-12">
                                <div class="col-xs-12 col-sm-5">
                                    <select name="b_id" class="selectpicker" id="bt_select">
                                        
                                    </select>
                                </div>
                                <div class="col-xs-12 col-sm-5">
                                    <select name="g_id" class="selectpicker" id="gr_select">
                            ...
                            <div class="col-xs-12 col-sm-12 table_padding">
                                <table class="text-center table table-striped table-condensed table-bordered" id="worktable">

                                    <tr>
                                        <th>Student ID</th>
                                        <th>Student Name</th>
                                        <th>Wroksnap Hours</th>
                                    </tr>
                            ...
                            <div class="col-xs-3 col-sm-3">
                                <input type="submit" class="btn btn-primary" value="Update" id="button_submit1">
                            </div>
                        </form>
