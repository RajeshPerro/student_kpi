...
<ul class="nav navbar-nav navbar-left">
    ...
    <li><a href="worksnap1.php"><span class="glyphicon glyphicon-send"></span> Worksnap Score</a></li>
    <li><a href="logout.php" id="sign-out"><span class="glyphicon glyphicon-log-out"></span>
            Sign Out</a></li>
    <li><a href="dashboard.php?user=<?php echo $_SESSION['user']?> &token=<?php echo $_SESSION['token']?>"><span class=""></span><?php echo $_SESSION['user']; ?></a></li>
