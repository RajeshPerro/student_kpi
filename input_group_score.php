...
if($_SESSION['user']==null && $_SESSION['token']==null ) {
    ...
    <head>
        ...
        <script type="text/javascript" src="js/group_score_update.js">
                ...
                <div class="back">
                    <div class="mainbody">
                        ...
                        <div class="row bg-white padding-top-bottom">
                            ...
                            <div class="col-xs-7 col-sm-7 text-left"><input type="text" id="of" placeholder="Out Of" name="outof" class="form-control"></div>
                            <br>
