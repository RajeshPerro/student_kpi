...
<!--                        <input id="input_file" type="file" name="file" class="form-control">-->
                       <a href="db_backup.php" target="blank" class="btn btn-lg btn-success"> Export DB</a>
                        <button type="submit" id="uploadButton" name="submit" class="btn btn-lg btn-info"> Import DB</button>
                    </div>
